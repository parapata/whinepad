...
const Store = require("../flux-imm/CRUDStore").default;
...
describe("Editing data", () => {
  it("saves new data", () => {
    ...
    //cell.dataset = {
      // hack around the DOM support in Jest
  ...
  it("deletes data", () => {
    ...
    expect(TestUtils.scryRenderedDOMComponentsWithTag(table, "td").length).toBe(
      0
    );
  });
});
